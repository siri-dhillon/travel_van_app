...
export class ConcertMax extends Component{
    constructor(props) {
        super(props);
        this.state = { 
            data_concerts: [],
    ...
    refreshList(){
      fetch(variables.API_URL+'concertmax')
  ...
  render () {
    ...
    return (
      ...
      <h1 className="mb-3 text-success">Below is the concert with the highest price</h1>
